    ...
    <View style={styles.p1}>
      <View style={styles.groupParent}>
        ...
        <View style={styles.rectangleContainer}>
          ...
          />
          <Text style={[styles.t1, styles.t1Typo]}>T- 1</Text>
        ...
        <Text style={[styles.t4, styles.t1Typo]}>T- 4</Text>
        <Text style={[styles.t4, styles.t1Typo]}>T- 4</Text>
        <Text style={[styles.t6, styles.t6Typo]}>T- 6</Text>
        <Text style={[styles.t7, styles.t6Typo]}>T- 7</Text>
        <Text style={[styles.t2, styles.t2Typo]}>T- 2</Text>
        <Text style={[styles.t3, styles.t2Typo]}>T- 3</Text>
        <Image
      ...
      <Image
        style={[styles.hgftghvghIcon7, styles.hgftghvghIconLayout]}
        contentFit="cover"
      ...
      />
      <Image
        style={[styles.hgftghvghIcon9, styles.hgftghvghIconLayout]}
        contentFit="cover"
      ...
      <Text style={[styles.t5, styles.t1Typo]}>T- 5</Text>
      <Image
      ...
      <Image
        style={styles.hgftghvghIcon13}
        contentFit="cover"
        source={require("../assets/hgftghvgh19.png")}
      />
      
      
      <TouchableOpacity onPress={() => navigation.navigate('Tank2')}>
      <Image
